...
class Website {
    ...
    async getViews() {
        ...
        return (0, util_1.merge)((0, util_1.merge)(thaliaViews, exampleViews), websiteViews);
    }
    async getScaffoldViews() {
        const exampleViews = await readAllViewsInFolder(path.join(process.cwd(), 'websites', 'example', 'views'));
        ...
        return (0, util_1.merge)((0, util_1.merge)(exampleViews, scaffoldViews), projectViews);
    }
}
