...
INSERT INTO `__new_albums`("id", "created_at", "updated_at", "deleted_at", "description", "name", "privacy", "url", "password") SELECT "id", "created_at", "updated_at", "deleted_at", "description", "name", "privacy", "url", "password" FROM `albums`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_fruit`("id", "created_at", "updated_at", "deleted_at", "name", "color", "taste") SELECT "id", "created_at", "updated_at", "deleted_at", "name", "color", "taste" FROM `fruit`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_images`("id", "created_at", "updated_at", "deleted_at", "caption", "album_id", "filename", "url", "original_size", "original_width", "original_height", "thumbnail_url", "archived_uri", "archived_size", "archived_md5", "image_key", "preferred_display_file_extension", "uri") SELECT "id", "created_at", "updated_at", "deleted_at", "caption", "album_id", "filename", "url", "original_size", "original_width", "original_height", "thumbnail_url", "archived_uri", "archived_size", "archived_md5", "image_key", "preferred_display_file_extension", "uri" FROM `images`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "created_at", "updated_at", "deleted_at", "name", "email", "password", "photo", "role", "locked", "verified") SELECT "id", "created_at", "updated_at", "deleted_at", "name", "email", "password", "photo", "role", "locked", "verified" FROM `users`;--> statement-breakpoint
