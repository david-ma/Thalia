...
var fs = require("fs");
var btoken = "ya29.TABZ8rwx1y-imSEAAAD-ZtZklWwxAxNPhMRRT8NBnleRyLmUI5sTY_ccFYSFtYZmQh_iYBRmHb72DUR-jdo";
var rtoken = "1/rA7OYkJVKrkLX7oXwcgM5XHqosTbGWFeMRtkDbVHBDc";
var client_id = "730829842327-gjcrpdk75a6q7baktbqn2v4fvqp3encl.apps.googleusercontent.com";
var client_secret = "9MY1iqhYd2yU-TeIn9sgudRP";
...
//			console.log("google auth is here!!!!!!!!!!!!:");
...
function cloneExcelSheet(auth_id){
	
}



// This is what David added to create a new google spreadsheet...
function newSpreadsheet(auth_id){
  var self = this;
  var google_auth;
...
//  console.log("refreshing token!");
  ...
  this.newSheet = function( cb ){

refreshToken();

fs.stat(__dirname+"/quiztemp.xlsx", function(err,d){
	var size = d.size;
	fs.readFile(__dirname+"/quiztemp.xlsx", {}, function(err,d,i){
		var options = {
...
//				Authorization: "Bearer 4/FHdbQRzVetq6nOjpl6K328M7RAl-.0mGJR_vy1NoTBrG_bnfDxpL8sKTRjgI",
				body: d
			}
/*
    if ( google_auth ) {
      if (google_auth.type === 'Bearer') {
        options.headers['Authorization'] = 'Bearer ' + google_auth.value;
      } else {
        options.headers['Authorization'] = "GoogleLogin auth=" + google_auth;
      }
    }
*/
...
var url = "https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=730829842327-gjcrpdk75a6q7baktbqn2v4fvqp3encl.apps.googleusercontent.com&redirect_uri=urn:ietf:wg:oauth:2.0:oob&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive"

//"https://accounts.google.com/o/oauth2/auth?response_type=code&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive&redirect_uri=http://www.google.com/&client_id=730829842327-gjcrpdk75a6q7baktbqn2v4fvqp3encl.apps.googleusercontent.com"


		oauth = {
//			callback: 'http://mysite.com/callback/',
//			response_type: "code",
			client_id: "730829842327-gjcrpdk75a6q7baktbqn2v4fvqp3encl.apps.googleusercontent.com",
    	client_secret: "9MY1iqhYd2yU-TeIn9sgudRP"
    }
...
/*
var opts = {
	url: "https://accounts.google.com/o/oauth2/token HTTP/1.1",
	method: "POST",
	"Content-Type": "application/x-www-form-urlencoded",
	"body": "code=4/kUWk97c0lGH7DAoQzrsmRwL2gsEk.Iq13TM4K4vMVBrG_bnfDxpLs16fRjgI&client_id=730829842327-gjcrpdk75a6q7baktbqn2v4fvqp3encl.apps.googleusercontent.com&client_secret=9MY1iqhYd2yU-TeIn9sgudRP&redirect_uri=urn:ietf:wg:oauth:2.0:oob&grant_type=authorization_code"
}

makeRequest(opts, function(e,d){
...
request.post({
	...
	"form":{
		"code": "4/P9P20y2n-VD5vwiHKcLFYEtcebnu.klWABxOrr3AaBrG_bnfDxpLE0DbSjgI",
		"client_id": "730829842327-gjcrpdk75a6q7baktbqn2v4fvqp3encl.apps.googleusercontent.com",
		"client_secret": "9MY1iqhYd2yU-TeIn9sgudRP",
...
*/
	...
	//					"Host": "accounts.google.com",
				...
				body: "client_id="+client_id+"&client_secret="+client_secret+"&refresh_token="+rtoken+"&grant_type=refresh_token"
			}
			
		request( options, function(err, response, body){
			if(!err) {
				btoken = JSON.parse(body).access_token;
			}
		});
	}
