			...
			boxes = racetrack.append("svg:g")
				...
				.each(function(d){
					d.forEach(function(id){
						...
						var pos = MINARDO.racetrack.getValidPos(d, Math.floor(i/2));
...
/*
			...
			rowNames = mySVG.append("svg:g").attr("id","rowNames");
...
// three areas...
	...
	"sectors":{},
	"getValidPos": function (id, sector){
		...
		if (MINARDO.racetrack.validPos(pos, sector)) {
			...
			return MINARDO.racetrack.getValidPos(id, sector);
		}
	},
